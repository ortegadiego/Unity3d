...
namespace UnitySampleAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        //las diferentes propiedades que adquirirá nuestro player
        //el termino Serialize... nos permite VERLAS y MANIPULARLAS desde el diseño en unity (fijate las propiedades)
        ...
        //fijate que se pueden agregar propiedades globales aqui que luego pueden ser tomadas desde el diseño
        // en este caso yo solo quise poner un bool de si es bonita Elizabeth... despues fijate como sale del lado del diseño
        [SerializeField] private bool esBonitaElyzabeth;
        ...
        //como lo dice el comentario habran propiedades que conviene solo setearlas aqui en el codigo
        ...
        private void Start()
        {
            //esta linea ya es conocida, con ella adquirimos a nuestro personaje para setearle los controles
            ...
            //con estos valores lo que hacemos es inicializar la vista de nuestro personaje, ajustar la camara
            //para que parezca la cabeza y tambien setear la forma de caminar
            _stepCycle = 0f;
        ...
        private void Update()
        {
            //si queres ver lo que hace el metodo de abajo, haces click sobre el y luego presionas la tecla F12
            RotateView();
            // the jump state needs to read here to make sure it is not missed
            //necesitamos un booleano para saber si esta saltando o no para terminar dicho estado
            if (!_jump)
                _jump = CrossPlatformInputManager.GetButtonDown("Jump");

            //estas preguntas siempre se van a hacer, es para dar el efecto del paso,
            //cuando este "pisando" que emita el sonido del paso
        ...
        //este es solo un metodo que emite el sonido del paso
